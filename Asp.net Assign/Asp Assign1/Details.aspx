<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="AspAssign.Details" %>
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="uname" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="vg">*</asp:RequiredFieldValidator>
        <p>
            ...
            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Family name must be different" ForeColor="Red" ControlToCompare="uname" ControlToValidate="fname" Operator="NotEqual" ValidationGroup="vg">*</asp:CompareValidator>
